...
public class ConversationGui extends javax.swing.JFrame implements IConversationGui{
    ...
    private JPanel messageShow(Message msg, boolean showSender) {
        ...
        for (i = 0; i < contents.size() - 1; i++) {//for every MyKindOfFile
            MyKindOfFile mkof = (MyKindOfFile) contents.get(i);
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/output-onlinepngtools (2).png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                MyKindOfFile MyKindOfFile = new MyKindOfFile(file, selectedFile.getName(), Files.probeContentType(selectedFile.toPath()));
                currentMessageContent.add(MyKindOfFile);
                ImageIcon icon = new ImageIcon(getClass().getResource("/output-onlinepngtools (2).png"));
                ...
                titleflow.add(new JLabel("Title : " + MyKindOfFile.getTitle()));
                JPanel typeflow = new JPanel(new FlowLayout(FlowLayout.LEFT));
                typeflow.add(new JLabel("Type : " + MyKindOfFile.getFileType()));
