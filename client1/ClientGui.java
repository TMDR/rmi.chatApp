...
public class ClientGui extends javax.swing.JFrame {
    ...
    private void helper() {
        ...
        try {
            ...
            try {
                String test =  "rmi://" + serverIP + ":2000/serv";
            ...
            if (br != null && !firstTime) {
                while ((line = br.readLine()) != null && !line.equals("\n")) {
                    ...
                    String Contents = Tokens[0].substring(Tokens[0].indexOf('[') + 1, Tokens[0].lastIndexOf(']'));// MyKindOfFile
                                                                                                                  // objects
                    ArrayList<Object> messageContents = new ArrayList<>();
                    while (Contents.contains(",")) {
                        String fileDescs = Contents.substring(0, Contents.indexOf(","));// one MyKindOfFile
                        ...
                        messageContents.add(new MyKindOfFile(contentBytes, title, type));
